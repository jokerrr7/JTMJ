...
elseif UserID == 1765160742 or UserID == 1866538640 or UserID == 1166711147 then  
...
if MsgText[1]== "الجوكر" or MsgText[1]=="جوكر" then
local inline = {{{text="DEV : JOKER",url="T.ME/eljo_ker_m"}}}
send_key(msg.sender_user_id_,'  عم الكل ♕',nil,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local text = " WELCOME TO 𝚂𝙾𝚄𝚁𝙲𝙴 J T M "
local inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 J T M  ☬',url="http://t.me/JT_M_3"}},
{{text = '-𝙳𝙴𝚅¹ ',url="https://t.me/eljo_ker_m"}},
{{text = '-DEV²  ',url="https://t.me/llllllTAllllll"}},
{{text = '-DEV³  ',url="https://t.me/QpSSpQ"}}, 
}   
...
elseif Text== "hell" or Text== "البوب" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/UU_0px)")
